...
var node_ffprobe_installer_1 = require("node-ffprobe-installer");
var execa = require("execa");
var isStream = require("is-stream");
function getFFprobeWrappedExecution(input) {
    var params = ['-v', 'error', '-show_format', '-show_streams'];
    if (typeof input === 'string') {
        return execa(node_ffprobe_installer_1.path, __spreadArray(__spreadArray([], params), [input]));
    }
    if (isStream(input)) {
        return execa(node_ffprobe_installer_1.path, __spreadArray(__spreadArray([], params), ['-i', 'pipe:0']), {
            reject: false,
            input: input,
        });
    }
